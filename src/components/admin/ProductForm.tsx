              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3 pt-4">
                  {watch('images')?.map((url) => (
                    <div key={url} className="relative group aspect-square">
                      <SafeImage src={url} alt="Imagem existente" width={150} height={150} className="w-full h-full object-cover rounded-md border border-primary-foreground/20" fallbackSrc="https://placehold.co/150x150.png" />
                  ...
                  {previews.map((previewUrl) => (
                     <div key={previewUrl} className="relative group aspect-square">
                      <SafeImage src={previewUrl} alt="Prévia da nova imagem" width={150} height={150} className="w-full h-full object-cover rounded-md border-2 border-secondary" fallbackSrc="https://placehold.co/150x150.png" />
