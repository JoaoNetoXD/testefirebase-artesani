...
export default function HomePage() {
  ...
  return (
    <div className="text-foreground"> {/* Ensure text color contrasts with dark background */}
      ...
      <section className="py-12 md:py-20">
        <div className="container mx-auto px-4 grid md:grid-cols-2 items-center gap-8 md:gap-12">
          ...
          <div className="space-y-6 text-center md:text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
              {benefits.map((benefit) => (
                <div key={benefit.title} className="flex flex-col items-center md:items-start text-center md:text-left p-3 rounded-lg hover:bg-primary-foreground/5 transition-colors">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-6 justify-center md:justify-start">
          ...
          <div className="flex justify-center md:justify-end mt-8 md:mt-0">
            <div className="relative bg-card p-4 sm:p-6 rounded-xl shadow-2xl max-w-sm w-full">
      ...
      <section className="py-12 bg-primary-foreground/5">
        <div className="container mx-auto px-4">
          ...
          <ProductList products={products.slice(0,4)} /> {/* Show a limited number of products */}
